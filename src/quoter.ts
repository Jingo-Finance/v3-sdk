...
import { BigintIsh, Currency, CurrencyAmount, TradeType } from '@jingofi/sdk-core'
import { encodeRouteToPath, MethodParameters, toHex } from './utils'
import IQuoter from '@jingofi/v3-periphery/artifacts/contracts/lens/Quoter.sol/Quoter.json'
import IQuoterV2 from '@jingofi/swap-router-contracts/artifacts/contracts/lens/QuoterV2.sol/QuoterV2.json'
...
/**
 * Represents the Jingo Finance V2 QuoterV1 contract with a method for returning the formatted
