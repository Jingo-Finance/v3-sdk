...
import { BigintIsh, Currency, CurrencyAmount, Percent, TradeType, validateAndParseAddress } from '@jingofi/sdk-core'
...
import ISwapRouter from '@jingofi/v3-periphery/artifacts/contracts/SwapRouter.sol/SwapRouter.json'
