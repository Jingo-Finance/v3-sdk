...
import IJingoV3Staker from '@jingofi/v3-staker/artifacts/contracts/JingoV3Staker.sol/JingoV3Staker.json'
...
export abstract class Staker {
  public static INTERFACE: Interface = new Interface(IJingoV3Staker.abi)
